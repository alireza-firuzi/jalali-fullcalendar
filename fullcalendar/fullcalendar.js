            ...
            element.find("th.fc-day-header").each(function ()
                {
                    if($(this).text() == "Sat")
                    {
                        $(this).text(persianCalConf.dayNames[6]);
                    }
                    else if($(this).text() == "Fri")
                    {
                        $(this).text(persianCalConf.dayNames[5]);
                    }
                    else if($(this).text() == "Thu")
                    {
                        $(this).text(persianCalConf.dayNames[4]);
                    }
                    else if($(this).text() == "Wed")
                    {
                        $(this).text(persianCalConf.dayNames[3]);
                    }
                    else if($(this).text() == "Tue")
                    {
                        $(this).text(persianCalConf.dayNames[2]);
                    }
                    else if($(this).text() == "Mon")
                    {
                        $(this).text(persianCalConf.dayNames[1]);
                    }
                    else if($(this).text() == "Sun")
                    {
                        $(this).text(persianCalConf.dayNames[0]);
                    }
                }
            );
            ...
            element.find('td.fc-widget-header th.fc-day-header').each(function()
                {
                    ...
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[6]);
                    }
                    else if($(this).hasClass("fc-sun"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[0]);
                    }
                    else if($(this).hasClass("fc-mon"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[1]);
                    }
                    else if($(this).hasClass("fc-tue"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[2]);
                    }
                    else if($(this).hasClass("fc-wed"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[3]);
                    }
                    else if($(this).hasClass("fc-thu"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[4]);
                    }
                    else if($(this).hasClass("fc-fri"))
                    {
                        $(this).text(weekdays[i]+" "+persianCalConf.dayNames[5]);
                    }
...
$.fn.fullCalendar = function(options) {
	...
	this.each(function(i, _element) { // loop each DOM element involved
		...
		// a new calendar initialization
            ...
            if (options.lang1 == "persianJalali")
            {
...
$.extend(Grid.prototype, {
	...
	getDayClasses: function(date) {
        ...
        if (persianCalConf.lang1 == "persianJalali")
        {
...
function View(calendar) {
	...
	(function() {
		...
		if (opt('weekends') === false) {
			hiddenDays.push(4, 5); // 0=sunday, 6=saturday
		}
...
$.extend(MonthView.prototype, {
	...
	render: function(date) {
        ...
        if (persianCalConf.lang1 == "persianJalali")
        {
            ...
            myjalal._locale._week.dow = 6;
            myjalal._locale._week.doy = 12;
//            myjalal._locale._months = ['فروردین','اردیبهشت','خرداد','تیر','مرداد','شهریور','مهر','آبان','آذر','دی','بهمن','اسفند'];
            myjalal._locale._ordinal = "%dم";
            myjalal._locale.relativeTime =  {
                future: "در %s",
                past: "%s پیش",
                s: "چندین ثانیه",
                m: "یک دقیقه",
